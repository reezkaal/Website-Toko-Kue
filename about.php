...
<html lang="en">
  <head>
    ...
    <link rel = "icon" href ="img/logotoko.jpg" type = "image/x-icon">
    <!-- Google Fonts -->
      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown">Welcome to <span>Kedai Kanzoe</span></h2>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Mulai Belanja</a>
              </div>
            </div>
          </div>
          <!-- Slide 2 -->
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                ...
                <p class="animate__animated animate__fadeInUp">Menjadi Toko Kue Nomor Satu di Tangerang</p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Mulai Belanja</a>
              </div>
            </div>
          </div>
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Aneka Hantaran</h2><p><a href="https://github.com/reezkaal" target="_blank">@kelompok B</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Mulai Belanja</a>
              </div>
            </div>
          </div>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <h3>Welcome to <strong>Kedai Kanzoe</strong></h3>
            <h3><strong>Toko Kue yang berada di kawasan Tangerang</strong></h3>
            <p class="font-italic">
          </div>
